...
function DailyBudgetWidget() {
  return (
    <section className="bg-white rounded-3xl mx-4 mt-4 border-indigo-100 shadow-sm p-4">
      {/* งบ / การตั้งค่า */}
      <div className="flex justify-between items-center mb-2">
        <p className="text-sm text-slate-600 font-bold ">งบที่ใช้ได้วันนี้</p>
        <button className="text-[10px] text-white font-bold h-7 w-14 bg-green-700 rounded-lg shadow-indigo-200 tracking-widest">
          ตั้งค่า
        </button>
      </div>
      {/* หลอดเงิน */}
